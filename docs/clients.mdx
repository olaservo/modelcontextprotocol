...
[Codex](https://github.com/openai/codex) is a lightweight AI-powered coding agent from OpenAI that runs in your terminal. It supports MCP server integration for accessing external tools and context.

**Key features:**

- Integrates with MCP servers for tool access
- Supports STDIO and streamable HTTP server types
