...
The API supports logging, opening URLs, sending follow-up messages to the host, and other host interactions. Since MCP Apps build on standard web primitives (HTML, JavaScript, `postMessage`), you can use any framework: React, Vue, Svelte, or vanilla JavaScript.
