...
<Note>
  To improve your chances of a SEP being approved, discuss your idea with the
  relevant [working or interest group in
  Discord](/community/communication#discord) before submitting. Working groups
  typically focus on priorities aligned with the [project
  roadmap](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/docs/development/roadmap.mdx),
  so early feedback helps ensure your proposal is well-aligned and saves you
  from investing effort in a direction that may not move forward.
</Note>
