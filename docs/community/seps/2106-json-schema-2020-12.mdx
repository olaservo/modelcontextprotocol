...
sidebarTitle: "SEP-2106: JSON Schema 2020-12 for Tools"
...
{
  "content": [
    { "type": "text", "text": "Found 2 users: Alice (u1, alice@example.com) and Bob (u2, bob@example.com)." }
  ],
  "structuredContent": [
...
- Original PR: [#881](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/881)
- Related issue: [#834](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/834)
- `outputSchema` type restriction inconsistency: [#1906](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1906)
- TypeScript SDK schema types: [typescript-sdk#1149](https://github.com/modelcontextprotocol/typescript-sdk/issues/1149)
- SEP-2200 (Clarify Tool Result Content and Model Visibility): [#2200](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2200)
...
This proposal builds on discussions in GitHub issue [#834](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/834) and incorporates feedback from the MCP community.
