...
<Note>
  MCP Apps is an extension to the [core MCP specification](/specification). Host support varies by
  client.
</Note>
...
| [MCP Inspector](https://github.com/modelcontextprotocol/inspector) | ✅ Supported     |
