...
- **Check alignment with [Core Maintainer](/community/governance#roles) priorities**, which are generally reflected in the [project roadmap](/development/roadmap), and review the [design principles](/community/design-principles). Proposals outside current priorities or that conflict with the project's design principles are more likely to face delays or additional friction in the review process.
