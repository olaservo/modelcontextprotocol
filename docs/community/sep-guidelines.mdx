...
<Note>
  To improve your chances of a SEP being approved:
...
- **If no relevant group exists**, share your idea with the general working group. If there is enough interest, it may be worth proposing a new group — the effort involved in finding sponsors and facilitators is a good signal of whether the idea has sufficient traction, and is still preferable to a cold submission.
- **Check alignment with core maintainer priorities**, which are generally reflected in the [project roadmap](/development/roadmap). Proposals outside current priorities are more likely to face delays or additional friction in the review process.
