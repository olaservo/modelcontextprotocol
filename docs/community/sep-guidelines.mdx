...
- **Check alignment with [Core Maintainer](/community/governance#roles) priorities**, which are generally reflected in the [project roadmap](/development/roadmap). Proposals outside current priorities are more likely to face delays or additional friction in the review process.
