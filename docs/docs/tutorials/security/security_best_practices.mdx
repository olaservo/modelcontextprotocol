...
<Note>
Use established libraries instead of manually parsing out IP addresses, as that
introduces a high degree of risk due to missing ranges or formatting options.
</Note>
