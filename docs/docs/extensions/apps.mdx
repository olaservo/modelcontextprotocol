...
Running `npm start` will start all the example servers in `basic-host`. To test only
a specific server (e.g., one you're developing), pass the `SERVERS` environment
variable inline:
...
[MCP Inspector](https://github.com/modelcontextprotocol/inspector), [Visual Studio Code (Insiders}](https://code.visualstudio.com/insiders), [Goose](https://block.github.io/goose/) and [Postman](https://postman.com). See the
...
1. **Use a framework**: [MCP-UI](https://github.com/MCP-UI-Org/mcp-ui) provides
   client-side support for MCP Apps (see [MCP-UI-Org/mcp-ui#147](https://github.com/MCP-UI-Org/mcp-ui/pull/147)).
