...
export const McpClient = ({ name, homepage, supports, children }) => {
  const slug = name
    .toLowerCase()
    .replace(/[().\s-]+/g, '-')
    .replace(/^-|-$/g, '');
...
<McpClient name="Amazon Q IDE" homepage="https://aws.amazon.com/q/developer" supports="Tools">
...
<McpClient name="Amp" homepage="https://ampcode.com" supports="Resources, Prompts, Tools, Sampling">
...
<McpClient name="Augment Code" homepage="https://augmentcode.com" supports="Tools">
...
<McpClient name="BeeAI Framework" homepage="https://framework.beeai.dev" supports="Tools">
...
<McpClient name="Chatbox" homepage="https://chatboxai.app" supports="Tools">
...
<McpClient name="ChatGPT" homepage="https://chatgpt.com" supports="Tools">
...
<McpClient name="Claude Code" homepage="https://claude.ai/download/claude-code" supports="Resources, Prompts, Tools, Roots, Instructions">
...
<McpClient name="Claude Desktop App" homepage="https://claude.ai/download" supports="Resources, Prompts, Tools">
...
<McpClient name="Cline" homepage="https://github.com/cline/cline" supports="Resources, Tools, Discovery">
...
<McpClient name="Continue" homepage="https://github.com/continuedev/continue" supports="Resources, Prompts, Tools">
...
<McpClient name="Cursor" homepage="https://docs.cursor.com/context/mcp#protocol-support" supports="Prompts, Tools, Roots, Elicitation">
...
<McpClient name="ECA - Editor Code Assistant" homepage="https://eca.dev" supports="Resources, Prompts, Tools, Roots">
...
<McpClient name="Gemini CLI" homepage="https://github.com/google-gemini/gemini-cli" supports="Prompts, Tools, Instructions">
...
<McpClient name="GenAIScript" homepage="https://microsoft.github.io/genaiscript/" supports="Resources, Tools">
...
<McpClient name="goose" homepage="https://github.com/block/goose" supports="Resources, Prompts, Tools, Sampling, Instructions">
...
<McpClient name="HyperAgent" homepage="https://github.com/hyperbrowserai/HyperAgent" supports="Tools">
...
<McpClient name="JetBrains AI Assistant" homepage="https://plugins.jetbrains.com/plugin/22282-jetbrains-ai-assistant" supports="Tools">
...
<McpClient name="JetBrains Junie" homepage="https://www.jetbrains.com/junie" supports="Tools">
...
<McpClient name="Kilo Code" homepage="https://github.com/Kilo-Org/kilocode" supports="Resources, Tools, Discovery">
...
<McpClient name="Klavis AI Slack/Discord/Web" homepage="https://www.klavis.ai/" supports="Resources, Tools">
...
<McpClient name="Langdock" homepage="https://langdock.com" supports="Tools">
...
<McpClient name="Langflow" homepage="https://github.com/langflow-ai/langflow" supports="Tools">
...
<McpClient name="LibreChat" homepage="https://github.com/danny-avila/LibreChat" supports="Tools, Instructions">
...
<McpClient name="LM Studio" homepage="https://lmstudio.ai" supports="Tools">
...
<McpClient name="mcp-agent" homepage="https://github.com/lastmile-ai/mcp-agent" supports="Resources, Prompts, Tools, Sampling (partial), Roots, Elicitation">
...
<McpClient name="MCPJam" homepage="https://github.com/MCPJam/inspector" supports="Resources, Prompts, Tools, Elicitation">
...
<McpClient name="Mistral AI: Le Chat" homepage="https://mistral.ai" supports="Tools">
...
<McpClient name="Needle" homepage="https://needle.app" supports="Resources, Prompts, Tools, Discovery">
...
<McpClient name="Roo Code" homepage="https://roocode.com" supports="Resources, Tools">
...
<McpClient name="TypingMind App" homepage="https://www.typingmind.com" supports="Tools">
...
<McpClient name="v0" homepage="https://v0.app" supports="Tools">
...
<McpClient name="VS Code GitHub Copilot" homepage="https://code.visualstudio.com/" supports="Resources, Prompts, Tools, Discovery, Sampling, Roots, Elicitation, Instructions">
...
<McpClient name="Warp" homepage="https://www.warp.dev/" supports="Resources, Tools, Discovery">
...
<McpClient name="Windsurf Editor" homepage="https://codeium.com/windsurf" supports="Tools, Discovery">
...
<McpClient name="Zed" homepage="https://zed.dev/docs/assistant/model-context-protocol" supports="Prompts, Tools">
...
<McpClient name="Zencoder" homepage="https://zencoder.ai" supports="Tools">
