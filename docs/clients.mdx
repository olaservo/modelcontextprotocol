...
export const McpClient = ({ name, homepage, children }) => {
  const slug = name
    .toLowerCase()
    .replace(/[().\s-]+/g, '-')
    .replace(/^-|-$/g, '');
  ...
  return (
    <div id={slug} className="relative group mt-8 scroll-mt-32">
      <a
        href={`#${slug}`}
        className="absolute -left-6 top-0 border-0 opacity-0 group-hover:opacity-100 text-xl text-gray-400 hover:text-gray-600"
...
<McpClient name="5ire" homepage="https://github.com/nanbingxyz/5ire">
...
<McpClient name="AgentAI" homepage="https://github.com/AdamStrojek/rust-agentai">
...
<McpClient name="AgenticFlow" homepage="https://agenticflow.ai/">
...
<McpClient name="AIQL TUUI" homepage="https://github.com/AI-QL/tuui">
...
<McpClient name="Amazon Q CLI" homepage="https://github.com/aws/amazon-q-developer-cli">
...
<McpClient name="Amazon Q IDE" homepage="https://aws.amazon.com/q/developer">
...
<McpClient name="Apify MCP Tester" homepage="https://github.com/apify/tester-mcp-client">
...
<McpClient name="Amp" homepage="https://ampcode.com">
...
<McpClient name="Augment Code" homepage="https://augmentcode.com">
...
<McpClient name="Avatar Shell" homepage="https://github.com/mfukushim/avatar-shell">
...
<McpClient name="BeeAI Framework" homepage="https://framework.beeai.dev">
...
<McpClient name="BoltAI" homepage="https://boltai.com">
...
<McpClient name="Call Chirp" homepage="https://www.call-chirp.com">
...
<McpClient name="Chatbox" homepage="https://chatboxai.app">
...
<McpClient name="ChatFrame" homepage="https://chatframe.co">
...
<McpClient name="ChatGPT" homepage="https://chatgpt.com">
...
<McpClient name="ChatWise" homepage="https://chatwise.app">
...
<McpClient name="Claude Code" homepage="https://claude.ai/download/claude-code">
...
<McpClient name="Claude.ai" homepage="https://claude.ai">
...
<McpClient name="Claude Desktop App" homepage="https://claude.ai/download">
...
<McpClient name="Chorus" homepage="https://chorus.sh">
...
<McpClient name="Cline" homepage="https://github.com/cline/cline">
...
<McpClient name="CodeGPT" homepage="https://codegpt.co">
...
<McpClient name="Continue" homepage="https://github.com/continuedev/continue">
...
<McpClient name="Copilot-MCP" homepage="https://github.com/VikashLoomba/copilot-mcp">
...
<McpClient name="Cursor" homepage="https://docs.cursor.com/context/mcp#protocol-support">
...
<McpClient name="Daydreams" homepage="https://github.com/daydreamsai/daydreams">
...
<McpClient name="ECA - Editor Code Assistant" homepage="https://eca.dev">
...
<McpClient name="Emacs Mcp" homepage="https://github.com/lizqwerscott/mcp.el">
...
<McpClient name="fast-agent" homepage="https://github.com/evalstate/fast-agent">
...
<McpClient name="FlowDown" homepage="https://github.com/Lakr233/FlowDown">
...
<McpClient name="FLUJO" homepage="https://github.com/mario-andreschak/flujo">
...
<McpClient name="Gemini CLI" homepage="https://github.com/google-gemini/gemini-cli">
...
<McpClient name="Genkit" homepage="https://github.com/firebase/genkit">
...
<McpClient name="Glama" homepage="https://glama.ai/chat">
...
<McpClient name="GenAIScript" homepage="https://microsoft.github.io/genaiscript/">
...
<McpClient name="goose" homepage="https://github.com/block/goose">
...
<McpClient name="GitHub Copilot coding agent" homepage="https://docs.github.com/en/copilot/concepts/about-copilot-coding-agent">
...
<McpClient name="gptme" homepage="https://github.com/gptme/gptme">
...
<McpClient name="HyperAgent" homepage="https://github.com/hyperbrowserai/HyperAgent">
...
<McpClient name="Jenova" homepage="https://jenova.ai">
...
<McpClient name="JetBrains AI Assistant" homepage="https://plugins.jetbrains.com/plugin/22282-jetbrains-ai-assistant">
...
<McpClient name="JetBrains Junie" homepage="https://www.jetbrains.com/junie">
...
<McpClient name="Kilo Code" homepage="https://github.com/Kilo-Org/kilocode">
...
<McpClient name="Klavis AI Slack/Discord/Web" homepage="https://www.klavis.ai/">
...
<McpClient name="Langdock" homepage="https://langdock.com">
...
<McpClient name="Langflow" homepage="https://github.com/langflow-ai/langflow">
...
<McpClient name="LibreChat" homepage="https://github.com/danny-avila/LibreChat">
...
<McpClient name="LM-Kit.NET" homepage="https://lm-kit.com/products/lm-kit-net/">
...
<McpClient name="LM Studio" homepage="https://lmstudio.ai">
...
<McpClient name="Lutra" homepage="https://lutra.ai">
...
<McpClient name="MCP Bundler for MacOS" homepage="https://mcp-bundler.maketry.xyz">
...
<McpClient name="mcp-agent" homepage="https://github.com/lastmile-ai/mcp-agent">
...
<McpClient name="mcp-client-chatbot" homepage="https://github.com/cgoinglove/mcp-client-chatbot">
...
<McpClient name="MCPJam" homepage="https://github.com/MCPJam/inspector">
...
<McpClient name="mcp-use" homepage="https://github.com/pietrozullo/mcp-use">
...
<McpClient name="modelcontextchat.com" homepage="https://modelcontextchat.com">
...
<McpClient name="MCPHub" homepage="https://github.com/ravitemer/mcphub.nvim">
...
<McpClient name="MCPOmni-Connect" homepage="https://github.com/Abiorh001/mcp_omni_connect">
...
<McpClient name="Memex" homepage="https://memex.tech/">
...
<McpClient name="Microsoft Copilot Studio" homepage="https://learn.microsoft.com/en-us/microsoft-copilot-studio/agent-extend-action-mcp">
...
<McpClient name="MindPal" homepage="https://mindpal.io">
...
<McpClient name="MooPoint" homepage="https://moopoint.io">
...
<McpClient name="Mistral AI: Le Chat" homepage="https://mistral.ai">
...
<McpClient name="Msty Studio" homepage="https://msty.ai">
...
<McpClient name="Needle" homepage="https://needle.app">
...
<McpClient name="NVIDIA Agent Intelligence (AIQ) toolkit" homepage="https://github.com/NVIDIA/AIQToolkit">
...
<McpClient name="OpenSumi" homepage="https://github.com/opensumi/core">
...
<McpClient name="oterm" homepage="https://github.com/ggozad/oterm">
...
<McpClient name="Roo Code" homepage="https://roocode.com">
...
<McpClient name="Postman" homepage="https://postman.com/downloads">
...
<McpClient name="RecurseChat" homepage="https://recurse.chat">
...
<McpClient name="Replit" homepage="https://replit.com/products/agent">
...
<McpClient name="Shortwave" homepage="https://www.shortwave.com">
...
<McpClient name="Simtheory" homepage="https://simtheory.ai">
...
<McpClient name="Slack MCP Client" homepage="https://github.com/tuannvm/slack-mcp-client">
...
<McpClient name="Smithery Playground" homepage="https://smithery.ai/playground">
...
<McpClient name="SpinAI" homepage="https://docs.spinai.dev">
...
<McpClient name="Superinterface" homepage="https://superinterface.ai">
...
<McpClient name="Superjoin" homepage="https://superjoin.ai">
...
<McpClient name="Swarms" homepage="https://github.com/kyegomez/swarms">
...
<McpClient name="systemprompt" homepage="https://systemprompt.io">
...
<McpClient name="Tambo" homepage="https://tambo.co">
...
<McpClient name="Tencent CloudBase AI DevKit" homepage="https://docs.cloudbase.net/ai/agent/mcp">
...
<McpClient name="TheiaAI/TheiaIDE" homepage="https://eclipsesource.com/blogs/2024/10/07/introducing-theia-ai/">
...
<McpClient name="Tome" homepage="https://github.com/runebookai/tome">
...
<McpClient name="TypingMind App" homepage="https://www.typingmind.com">
...
<McpClient name="v0" homepage="https://v0.app">
...
<McpClient name="VS Code GitHub Copilot" homepage="https://code.visualstudio.com/">
...
<McpClient name="VT Code" homepage="https://github.com/vinhnx/vtcode">
...
<McpClient name="Warp" homepage="https://www.warp.dev/">
...
<McpClient name="WhatsMCP" homepage="https://wassist.app/mcp/">
...
<McpClient name="Windsurf Editor" homepage="https://codeium.com/windsurf">
...
<McpClient name="Witsy" homepage="https://github.com/nbonamy/witsy">
...
<McpClient name="Zed" homepage="https://zed.dev/docs/assistant/model-context-protocol">
...
<McpClient name="Zencoder" homepage="https://zencoder.ai">
