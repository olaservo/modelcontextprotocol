...
<Note>
  **Key dates:**
  - **January 15, 2026**: Conformance tests available
  - **February 15, 2026**: Official SDK tiering published

SDK maintainers have one month between these dates to work with the
...
All SDKs are evaluated using [automated conformance tests](https://github.com/modelcontextprotocol/conformance) that validate protocol conformance. SDKs receive a conformance score based on test results:
