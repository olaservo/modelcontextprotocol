...
<Steps>
  <Step title="Install the skill">
    ...
    Alternatively, you can use the [Vercel Skills CLI](https://vercel.com/changelog/introducing-skills-the-open-agent-skills-ecosystem) to install skills across different agents:
