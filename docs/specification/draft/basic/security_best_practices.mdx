...
- Sandboxes technologies are complex and sometimes new vulnerabilities are found. MCP clients should update to the latest version of the sandbox technology.
